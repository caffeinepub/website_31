...
export default function GrowthForm() {
  ...
  const validate = () => {
    ...
    if (
      muac &&
      (Number.isNaN(Number(muac)) || Number(muac) < 5 || Number(muac) > 25)
    )
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const status = classifyNutritionalStatus(
      bmi,
      Number(ageMonths),
      muac ? Number(muac) : undefined,
    );
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div className="col-span-2 space-y-1">
                ...
                />
                {errors.name && (
                  <p className="text-xs text-status-red">{errors.name}</p>
                )}
              </div>
              ...
              <div className="space-y-1">
                ...
                />
                {errors.ageMonths && (
                  <p className="text-xs text-status-red">{errors.ageMonths}</p>
                )}
              </div>
              ...
              <div className="space-y-1">
                ...
                {errors.gender && (
                  <p className="text-xs text-status-red">{errors.gender}</p>
                )}
              </div>
              ...
              <div className="space-y-1">
                ...
                />
                {errors.height && (
                  <p className="text-xs text-status-red">{errors.height}</p>
                )}
              </div>
              ...
              <div className="space-y-1">
                ...
                />
                {errors.weight && (
                  <p className="text-xs text-status-red">{errors.weight}</p>
                )}
              </div>
              ...
              <div className="col-span-2 space-y-1">
                ...
                />
                {errors.muac && (
                  <p className="text-xs text-status-red">{errors.muac}</p>
                )}
              </div>
            </div>
