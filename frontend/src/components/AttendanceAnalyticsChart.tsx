...
export default function AttendanceAnalyticsChart({ data }: AttendanceAnalyticsChartProps) {
  return (
    <Card className="shadow-card">
      <CardContent className="p-4">
        <h3 className="font-heading font-semibold text-sm mb-3">Monthly Attendance Trend</h3>
