...
import { Users, AlertTriangle, AlertCircle, UserCheck } from 'lucide-react';
    ...
    <div className="space-y-3">
      ...
      <Card className="shadow-card">
        <CardContent className="p-4 flex items-center gap-4">
          ...
          <div>
            <p className="text-2xl font-bold font-heading text-primary">{todayAttendanceRate}%</p>
            <p className="text-xs text-muted-foreground">Average Monthly Attendance Rate</p>
          </div>
