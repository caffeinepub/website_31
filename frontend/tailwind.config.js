    ...
    theme: {
        ...
        extend: {
            colors: {
                ...
                'status-green-bg': 'oklch(var(--status-green-bg))',
                'status-yellow': 'oklch(var(--status-yellow))',
                'status-yellow-bg': 'oklch(var(--status-yellow-bg))',
                'status-red': 'oklch(var(--status-red))',
                'status-red-bg': 'oklch(var(--status-red-bg))',
            },
            fontFamily: {
